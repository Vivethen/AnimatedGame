...
var wwwww = 0;
var carX = -5000;
var carY = random(50,350);
var fighterjetX = -8000;
var fighterjetY = random(50,350);
var speedSterX = 0;
var speedSterY = random(-50,-450);
var ob = 0;
var H1 = 0.00;
var H2 = 40.897;
var H3 = H2*2;
...
var H9 = H2*8;
var H10 = H2*9;
var heightH1 = random(-60, -150);
var heightH2 = random(-60, -150);
var heightH3 = random(-60, -150);
var heightH4 = random(-60, -150);
var heightH5 = random(-60, -150);
var heightH6 = random(-60, -150);
var heightH7 = random(-60, -150);
var heightH8 = random(-60, -150);
var heightH9 = random(-60, -150);
var heightH10 = random(-60, -150);
var spaceSpeed = 0;
var starPower = 0;
var sun = 430;
var x = 81;
...
if (score > 10000){
    ...
    ellipse(sun,10,60,60);
    fill(12, 46, 240);
image(getImage("cute/TreeTall"), H2, 70, 100, 150);
image(getImage("cute/TreeTall"), H4, 70, 100, 150);
image(getImage("cute/TreeTall"), H6, 70, 100, 150);
image(getImage("cute/TreeTall"), H8, 70, 100, 150);
image(getImage("cute/TreeTall"), H10, 70, 100, 150);
image(getImage("cute/TreeTall"), H1, 255, 100, 150);
image(getImage("cute/TreeTall"), H3, 170, 100, 150);
image(getImage("cute/TreeTall"), H5, 160, 100, 150);
image(getImage("cute/TreeTall"), H7, 250, 100, 150);
image(getImage("cute/TreeTall"), H9, 190, 100, 150);
...
ellipse(speedSterX,speedSterY,starPower,starPower);
    ...
    if (d < y + 41 && d > y - 21 && wwww < x + 41 && wwww > x - 21 && carY === y + 40 && carX === x + 16) {
        carY = random(0, 400);
        carX = -1000;
    }
    ...
    if (e < y + 41 && e > y - 21 && wwwww < x + 41 && wwwww > x - 21 && carY === y + 40 && carX === x + 16) {
        carY = random(0, 400);
        carX = -1000;
    }
...
if (score > 50000){
    ...
    if (speedSterY < y + 40 && speedSterY > y && speedSterX < x + 40 && speedSterX > x - 40) {
        ...
        if (speedSterX === x + 20 && speedSterY === y + 20){
            if (keyIsPressed && keyCode === CONTROL && starPower === 0) {
                    starPower++;
                }
    ...
    if (a < y + 41 && a > y - 21 && w < x + 41 && w > x - 21 && carY === y + 40 && carX === x + 16) {
        carY = random(0, 400);
        carX = -1000;
    }
    if (b < y + 41 && b > y - 21 && ww < x + 41 && ww > x - 21 && carY === y + 40 && carX === x + 16) {
        carY = random(0, 400);
        carX = -1000;
    }
    if (c < y + 41 && c > y - 21 && www < x + 41 && www > x - 21 && carY === y + 40 && carX === x + 16) {
        carY = random(0, 400);
        carX = -1000;
    }
